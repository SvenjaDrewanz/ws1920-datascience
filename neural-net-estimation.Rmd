...
train_ind <- sample(seq_len(nrow(dataset)), size = floor(0.80 * nrow(dataset)))
...
train_predictions <- (train_predictions_norm * norm_values_list$sd[1] ) + norm_values_list$sd[1]
test_predictions <- (test_predictions_norm * norm_values_list$sd[1]) + norm_values_list$sd[1]
